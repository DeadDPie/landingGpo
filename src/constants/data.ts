...
export const reviewsData = {
  ...
  reviews: [
    {
      id: "1",
      text: "Заказывали торт на юбилей! Было не только невли торт на юбилей! Было не только невероятно красиво, но и очень вкусно! Все гости были в востероятно красиво, но и очень вкусно! Все гости были в восторге. Обязательно будем заказывать еще!",
